...
//Menu choices
define('_AM_XASSET_ADMIN_TITLE', '%s Administrator Menu');
define('_AM_XASSET_BLOCK_TEXT', 'Manage Blocks');
define('_AM_XASSET_UPDATE_MODULE', 'Update Module');
define('_AM_XASSET_ADMIN_GOTOMODULE', 'Go To Module');
...
define('_AM_XASSET_GROUP_PERM_TITLE', 'Modify Group Permissions');
define('_AM_XASSET_GROUP_PERM_NAME', 'Permissions');
define('_AM_XASSET_GROUP_PERM_DESC', 'Select service(s) that each group should be allowed to modify');

// Buttons
define('_AM_XASSET_BUTTON_DELETE', 'Delete');
define('_AM_XASSET_BUTTON_EDIT', 'Edit');
define('_AM_XASSET_BUTTON_SUBMIT', 'Submit');
define('_AM_XASSET_BUTTON_RESET', 'Reset');
define('_AM_XASSET_BUTTON_CANCEL', 'Cancel');
define('_AM_XASSET_BUTTON_UPDATE', 'Update');
define('_AM_XASSET_BUTTON_SEARCH', 'Search');
